...
echo ""
echo "  Next steps:"
echo "    1. Compile Rocq (~30 s):"
echo "         cd rocq && OPAMROOT=\"$ARTIFACT_DIR/.opam\" opam exec --switch=rocq -- rocq compile Arbitrage.v"
echo ""
echo "    2. Activate the Python virtual env (required for pipeline):"
echo "         source $ARTIFACT_DIR/.venv/bin/activate"
echo ""
